package com.burning8393.ormtest.step030;

import com.burning8393.ormtest.step030.entity.UserEntity;
import com.burning8393.ormtest.step030.entity.XxxEntityHelper;
...
public class App030 {
    ...
    private void start() {
        ...
        try {
            ...
            XxxEntityHelper helper = new XxxEntityHelper();
            ...
            while (rs.next()) {
                // 创建新的实体对象
                UserEntity userEntity = helper.create(UserEntity.class, rs);
