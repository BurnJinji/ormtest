package com.burning8393.ormtest.step040;

import com.burning8393.ormtest.step040.entity.AbstractEntityHelper;
import com.burning8393.ormtest.step040.entity.EntityHelperFactory;
import com.burning8393.ormtest.step040.entity.UserEntity;
...
public class App040 {
    ...
    private void start() {
        ...
        try {
            ...
            while (rs.next()) {
                // 创建新的实体对象
                UserEntity userEntity = (UserEntity) helper.create(rs);
